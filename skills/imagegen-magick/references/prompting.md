...
- Use `font-family="Cascadia Next SC NF Regular"` for all text (built-in font, supports Chinese + English).
...
- Use `font-family="Cascadia Next SC NF Regular"` for all text elements.
