...
`public/` 下的所有文件（SKILL.md、HTML 参考页面、SVG 图标）都会自动复制到 `skills/hq/`。
...
- `public/` 下的 HTML 文件（futures_fee.html、hf.html）是交互式参考页面，会被复制到 skills/
- SKILL.md 中要求 Agent 每次回复都固定输出这 2 个参考页面的链接
- 所有代码使用中文注释
